...
|1.8|2023-04-04|ARM32 for EABI、AMD x86-64 architecture、Intel 80386、MIPS I Architecture、Advanced RISC Machines ARM、PowerPC32|Add support for PowerPC32 and support finding main function.|
## Background
