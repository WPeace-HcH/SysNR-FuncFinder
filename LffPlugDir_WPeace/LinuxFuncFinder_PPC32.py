...
linux_func += ['_WPe_sgetmask']
linux_func += ['_WPe_ssetmask']
...
linux_func += ['_WPe_profil']
linux_func += ['_WPe_statfs']
linux_func += ['_WPe_fstatfs']
linux_func += ['_WPe_ioperm']
linux_func += ['_WPe_socketcall']
...
linux_func += ['_WPe_olduname']
linux_func += ['_WPe_iopl']
linux_func += ['_WPe_vhangup']
linux_func += ['_WPe_idle']
linux_func += ['_WPe_vm86']
...
linux_func += ['_WPe_getpmsg']
linux_func += ['_WPe_putpmsg']
...
linux_func += ['_WPe_Unused']
linux_func += ['_WPe_tuxcall']
...
linux_func += ['_WPe_swapcontext']
linux_func += ['_WPe_tgkill']
linux_func += ['_WPe_utimes']
linux_func += ['_WPe_statfs64']
linux_func += ['_WPe_fstatfs64']
linux_func += ['_WPe_fadvise64_64']
linux_func += ['_WPe_rtas']
linux_func += ['_WPe_sys_debug_setcontext']
linux_func += ['_WPe_reserved_for_vserver']
linux_func += ['_WPe_migrate_pages']
...
linux_func += ['_WPe_spu_run']
linux_func += ['_WPe_spu_create']
...
linux_func += ['_WPe_sync_file_range2']
linux_func += ['_WPe_fallocate']
linux_func += ['_WPe_subpage_prot']
...
linux_func += ['_WPe_kexec_file_load']
linux_func += ['_WPe_statx']
linux_func += ['_WPe_pkey_alloc']
linux_func += ['_WPe_pkey_free']
linux_func += ['_WPe_pkey_mprotect']
linux_func += ['_WPe_rseq']
linux_func += ['_WPe_io_pgetevents']
linux_func += ['_WPe_room_for_arch_specific_syscalls']
linux_func += ['_WPe_room_for_arch_specific_syscalls']
linux_func += ['_WPe_room_for_arch_specific_syscalls']
...
linux_func += ['_WPe_clock_gettime64']
linux_func += ['_WPe_clock_settime64']
linux_func += ['_WPe_clock_adjtime64']
linux_func += ['_WPe_clock_getres_time64']
linux_func += ['_WPe_clock_nanosleep_time64']
linux_func += ['_WPe_timer_gettime64']
linux_func += ['_WPe_timer_settime64']
linux_func += ['_WPe_timerfd_gettime64']
linux_func += ['_WPe_timerfd_settime64']
linux_func += ['_WPe_utimensat_time64']
linux_func += ['_WPe_pselect6_time64']
linux_func += ['_WPe_ppoll_time64']
linux_func += ['_WPe_Unused']
linux_func += ['_WPe_io_pgetevents_time64']
linux_func += ['_WPe_recvmmsg_time64']
linux_func += ['_WPe_mq_timedsend_time64']
linux_func += ['_WPe_mq_timedreceive_time64']
linux_func += ['_WPe_semtimedop_time64']
linux_func += ['_WPe_rt_sigtimedwait_time64']
linux_func += ['_WPe_futex_time64']
linux_func += ['_WPe_sys_sched_rr_get_interval']
linux_func += ['_WPe_pidfd_send_signal']
linux_func += ['_WPe_io_uring_setup']
linux_func += ['_WPe_io_uring_enter']
linux_func += ['_WPe_io_uring_register']
linux_func += ['_WPe_open_tree']
linux_func += ['_WPe_move_mount']
linux_func += ['_WPe_fsopen']
linux_func += ['_WPe_fsconfig']
linux_func += ['_WPe_fsmount']
linux_func += ['_WPe_fspick']
linux_func += ['_WPe_pidfd_open']
linux_func += ['_WPe_clone3']
linux_func += ['_WPe_close_range']
linux_func += ['_WPe_openat2']
linux_func += ['_WPe_pidfd_getfd']
linux_func += ['_WPe_faccessat2']
linux_func += ['_WPe_process_madvise']
linux_func += ['_WPe_epoll_pwait2']
linux_func += ['_WPe_mount_setattr']
linux_func += ['_WPe_quotactl_fd']
linux_func += ['_WPe_landlock_create_ruleset']
linux_func += ['_WPe_landlock_add_rule']
linux_func += ['_WPe_landlock_restrict_self']
linux_func += ['_WPe_reserved_for_memfd_secret']
linux_func += ['_WPe_process_mrelease']
linux_func += ['_WPe_futex_waitv']
linux_func += ['_WPe_set_mempolicy_home_node']
...
socket_func += ['listen']
socket_func += ['accept']
socket_func += ['getsockname']
socket_func += ['getpeername']
socket_func += ['socketpair']
socket_func += ['send']
socket_func += ['recv']
socket_func += ['sendto']
socket_func += ['recvfrom']
socket_func += ['shutdown']
socket_func += ['setsockopt']
socket_func += ['getsockopt']
socket_func += ['sendmsg']
socket_func += ['recvmsg']
socket_func += ['accept4']
socket_func += ['recvmmsg']
    ...
    for func in idautils.Functions():
        ...
        for line in dism_addr:
            ...
            while op == "sc":
                ...
                if op_last == "li" and idc.get_operand_value(lastline, 0) == 0:
                    ...
                    if funcName != "start" and funcName != "_WPe_fork":
                        if linux_func[callnumber] == "_WPe_socketcall":
                            ...
                            for xrefAddr in xrefs:
                                sockNrAddr = idc.prev_head(xrefAddr.frm)
                                socketop = idc.print_insn_mnem(sockNrAddr)
                                while socketop != "li":
                                    sockNrAddr = idc.prev_head(sockNrAddr)
                                    socketop = idc.print_insn_mnem(sockNrAddr)
                                socketFuncAddress = idc.get_name_ea_simple(idc.get_func_name(sockNrAddr))
                                socketNumber = idc.get_operand_value(sockNrAddr, 1)
                                idc.set_name(socketFuncAddress, socket_func[socketNumber], SN_FORCE)
                    ...
                    lastline = idc.prev_head(lastline)
    print("LinuxFuncFinder_PPC32 finished！总共重命名%d个函数" %sum)
...
def GetMainFunc(func):
    ...
    if mainOP == "r3":
        mainAddr = idc.get_name_ea_simple(mainAddrStr)
